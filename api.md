...
Authorize a device.
This call marks a device as authorized or revokes authorization for tailnets where device authorization is required, according to the `authorized` field in the payload.
